...
import { useSurveyChoice } from '../App';
        ...
        <div className="section-container">
          ...
          <div className="about-content">
            <div className="about-text">
              <h3>أستاذ رياضيات</h3>
              <p>
                أعمل كأستاذ للرياضيات في السلك الثانوي التأهيلي ولدي خبرة تمتد لـ 5 سنوات في إنتاج استعمالات الزمن 
          ...
          <div className="about-cta">
            ...
            <div className="cta-buttons">
              <button className="btn-primary" onClick={() => setShowSurveyChoice(true)}>
                اطلب الخدمة
              </button>
