      ...
      <section className="portfolio page-portfolio" id="portfolio">
        <div className="section-container">
          ...
          <div className="portfolio-cta">
            ...
            <button className="btn-primary" onClick={() => setShowSurveyChoice(true)}>اطلب خدمتك الآن</button>
          </div>
        </div>
      </section>
        ...
        <div className="modal-overlay open" onClick={() => setSelectedItem(null)}>
          <div className="modal-box modal-portfolio" onClick={e => e.stopPropagation()}>
            ...
            <div className="pm-footer">
              <button className="btn-primary" onClick={() => setShowSurveyChoice(true)}>اطلب خدمة مماثلة</button>
            </div>
          </div>
        </div>
      )}
